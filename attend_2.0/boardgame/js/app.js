...
var game = [
    ...
    ["티슈 입으로 불어서 30초 동안 안 떨어뜨리기(팀에서 2명)", "티슈 입으로 불어서 40초 동안 안 떨어뜨리기(팀에서 2명)", "티슈 입으로 불어서 50초 동안 안 떨어뜨리기(팀에서 2명)"], //5
    ...
    ["5번 안에 물병세우기", "4번 안에 물병세우기", "3번 안에 물병세우기"]]; //18
...
//    var windowHeight = window.outerHeight;
    ...
    $(".tArea4").css("text-shadow","4px 4px 4px gold");
    $(".tArea8").css("text-shadow","4px 4px 4px gold");
    $(".tArea12").css("text-shadow","4px 4px 4px gold");
};
...
var downGameCount = function(boxIndex){
    
    if(gameCount[boxIndex-1] > 0){
        gameCount[boxIndex-1] = gameCount[boxIndex-1] -1;
    }
}
